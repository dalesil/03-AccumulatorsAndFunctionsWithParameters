...
def draw_circles2():
    ...
    for k in range(22):
        ...
        radius = 10
        lucas2 = rg.Circle(center, radius)
        lucas2.fill_color = 'blue'
        lucas2.attach_to(window2)
    window2.render()
...
def draw_circles3():
    ...
    window3 = rg.RoseWindow(width=300, height=300)
    for k in range(100):
        center = rg.Point(200, 150)
        radius = 1 + k
        lucas3 = rg.Circle(center, radius)
        lucas3.attach_to(window3)
    window3.render()
...
def draw_cosines_and_sines():
    ...
    print('--------------------------------------------------')
    window4 = rg.RoseWindow(width=400, height=400)
    for k in range(100):
        center = rg.Point((200 + (80 * math.cos(k))), (200 + (80 * math.sin(k))))
        radius = 10
        lucas4 = rg.Circle(center, radius)
        lucas4.attach_to(window4)
    window4.render()
